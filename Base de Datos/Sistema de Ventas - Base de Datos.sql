...
select p.idProducto, p.nombre, p.cantidad, p.precio, p.descripcion, p.porcentajeItbis, c.descripcion as categoria, p.estado from tb_producto as p, tb_categoria as c where p.idCategoria = c.idCategoria
